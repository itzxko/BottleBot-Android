...
export default function index() {
  return (
    <View className="flex-1 w-full bg-black">
      <View className="w-full h-[30vh] bg-black"></View>
      <View className="w-full h-[80vh] bg-white rounded-t-[40px] items-center justify-center px-8">
        ...
        <View className="w-full flex items-start justify-center py-6">
          ...
          <TextInput
            className="bg-white w-full border border-black px-4 py-2 rounded-md"
